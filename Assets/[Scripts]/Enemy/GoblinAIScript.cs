...
public class GoblinAIScript : MonoBehaviour
{
    ...
    public void PlayWalkSound()
    {
        if (playerInAudioRange)
            SoundManager.Instance.PlayGoblinSound(0);
    }

    public void PlayAttackSound()
    {
        if (playerInAudioRange)
            SoundManager.Instance.PlayGoblinSound(1);
    }

    public void PlayHurtSound()
    {
        if (playerInAudioRange)
            SoundManager.Instance.PlayGoblinSound(2);
    }

    public void PlayDieSound()
    {
        if (playerInAudioRange)
            SoundManager.Instance.PlayGoblinSound(3);
